...
function bigfirst(){
	...
	if(first==0){
		...
		document.getElementById('blogme').style.display="none";
		document.getElementById('perfectme').style.display="none";
		document.getElementById('flightme').style.display="none";
		document.getElementById('hotelme').style.display="none";
		document.getElementById('festiveme').style.display="none";
	...
	//	document.getElementById('first').style.display = "none";
		...
		setTimeout(function(){
			document.getElementById('blogpage').style.display = "block";
			blogpage.className="animated fadeIn";
		},300);
		setTimeout(function(){
			document.getElementById('blogs').style.display = "block";
			blogs.className="animated fadeIn";
		},300);
		setTimeout(function(){
			document.getElementById('blogss').style.display = "block";
			blogss.className="animated fadeIn";
		},300);
		first =1;
	}
	else if(first == 1){
		...
		document.getElementById("first").style.width="100%";
		document.getElementById("first").style.height="30%";
		...
		setTimeout(function(){
			document.getElementById('blogpage').style.display = "block";
			blogpage.className="animated fadeOut";
		},300);
		
		setTimeout(function(){
			document.getElementById('blogs').style.display = "block";
			blogs.className="animated fadeOut";
		},300);

		setTimeout(function(){
			document.getElementById('blogss').style.display = "block";
			blogss.className="animated fadeOut";
		},300);
		setTimeout(function(){
	//	document.getElementById('first').style.display = "block";
		document.getElementById('blogme').style.display="block";
		document.getElementById('perfectme').style.display="block";
		document.getElementById('flightme').style.display="block";
		document.getElementById('hotelme').style.display="block";
		document.getElementById('festiveme').style.display="block";
